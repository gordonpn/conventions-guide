...
Refer to [README_template.md](https://github.com/gordonpn/conventions-guide/blob/master/docs/README_template.md) for an outline and templates from [The Documentation Compendium](https://github.com/kylelobo/The-Documentation-Compendium/tree/master/en/README_TEMPLATES)
